              ...
              child: Column(
                children: [
                  ...
                  Text(current == 1 ? 'day streak' : 'day streak',
                      style: poppins(15, FontWeight.w600, AppColors.muted)),
                  const SizedBox(height: 14),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    child: Text(message,
                        textAlign: TextAlign.center,
                        style: poppins(13.5, FontWeight.w500, AppColors.ink)),
                  ),
                ],
              ),
            ),
  ...
  Widget _dayDot(DayInfo d) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text(d.label,
            style: poppins(12, d.isToday ? FontWeight.w700 : FontWeight.w500,
